...
app.get("/get/users-comments", async (req, res) => {
...
app.post("/new-message", upload.none(), async (req, res) => {
  let username = sessions[req.cookies.sid];
...
app.post("/modal", upload.none(), async (req, res) => {
  console.log("request to /modal");
...
app.post("/check-profile", upload.none(), async (req, res) => {
...
app.post("/edit/profile", upload.single("image"), async (req, res) => {
  ...
  try {
    ...
    let user = await dbo.collection("users").findOneAndUpdate(
      { username },
      {
        $set: {
...
app.post("/edit/password", upload.none(), async (req, res) => {
  let username = sessions[req.cookies.sid];
...
app.post("/handle-follow", upload.none(), async (req, res) => {
  let username = sessions[req.cookies.sid];
...
app.post("/delete-comment", upload.none(), async (req, res) => {
...
app.post("/like-post", upload.none(), async (req, res) => {
